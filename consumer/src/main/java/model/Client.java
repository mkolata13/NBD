...
public class Client extends AbstractEntity {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(firstName, client.firstName).append(lastName, client.lastName).append(phoneNumber, client.phoneNumber).append(clientType, client.clientType).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(firstName).append(lastName).append(phoneNumber).append(clientType).toHashCode();
    }
}
