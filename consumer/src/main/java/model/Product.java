...
public class Product extends AbstractEntity {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(basePrice, product.basePrice).append(weight, product.weight).append(quantity, product.quantity).append(isAvailable, product.isAvailable).append(name, product.name).append(description, product.description).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(name).append(basePrice).append(weight).append(quantity).append(description).append(isAvailable).toHashCode();
    }
}
